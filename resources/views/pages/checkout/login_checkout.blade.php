   ...
   <div class="row">
	...
	{{csrf_field()}}
       <div class="form-group">
           ...
           <input class="form-control"  name="email_account"  required="" placeholder="Email" type="email"><span class="help-block"></span> 
       </div>
       <div class="form-group">
           <label for="password" class="control-label">Mật khẩu</label>
           <input type="password" class="form-control"  name="password_account"  required=""  placeholder="Password" ><span class="help-block"></span> 
       </div>
       ...
       <a href="{{URL::to ('/register-checkout')}}" class="btn btn-danger btn-block">Đăng ký</a>
      </form>
     </div>
    </div>
    <div class="col-xs-6">
